...
\begin{detail}
\SubBulletItem
Increased PVS engine realtime packet processing speed by 35\% by designing, implementing, and testing an optimized plugin evaluation algorithm with preprocessing in C.
\SubBulletItem
Created a classifier with SKLearn to classify network flows by category; model yielded 98\% test accuracy.
